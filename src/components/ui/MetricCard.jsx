...
const={background:"var(--accent)",color:"#fff",border:"none",borderRadius:100,width:30,height:30,cursor:"pointer",fontSize:15,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0};
