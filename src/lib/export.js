...
function exportDealPDF(deal, user) {
  ...
  doc.setFontSize(7.5);
  doc.setTextColor(...MUTED);
  doc.text('Generated by RentHack · renthack.io  |  RentHack provides financial projections for informational purposes only. Not financial, legal, or tax advice. Consult qualified professionals before investing.', W / 2, H - 18, { align: 'center' });
  ...
  doc.setFontSize(7.5);
  doc.setTextColor(...MUTED);
  doc.text('Generated by RentHack · renthack.io  |  ' + 'RentHack provides financial projections for informational purposes only. Not financial, legal, or tax advice. Consult qualified professionals before investing.', W / 2, H - 26, { align: 'center' });
  doc.text('Results are projections based on user-entered assumptions and are not guaranteed. renthack.io/legal/tos', W / 2, H - 16, { align: 'center' });
  doc.text('2', R, H - 16, { align: 'right' });
